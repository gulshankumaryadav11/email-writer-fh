...
:root {
  ...
  /* Gradients without blue/purple */
  --gradient-hero: linear-gradient(135deg, #faf8f5 0%, #f5f1ec 50%, #e8e4df 100%);
  --gradient-card: linear-gradient(135deg, #c17f59 0%, #d49a7a 100%);
  --gradient-soft: linear-gradient(135deg, #8b9a7d 0%, #a8b899 100%);
  --gradient-warm: linear-gradient(135deg, #d4a574 0%, #c17f59 100%);
}
  --text: #f1f5f9;
  --text-muted: #94a3b8;
  --border: #475569;
...
/* Buttons - Organic, hand-pressed feel */
.lp-btn-primary {
  padding: 12px 24px;
  border-radius: 12px;
  border: none;
